...
- **Covered (human implements; Claude guides + reviews only):** the from-scratch **C++
  backend** (`/backend`) — Milestone 0 and the C++ parts of M1–M6.
- **NOT covered (Claude may assist normally, including writing code):** the **Angular/
  TypeScript frontend** (`/frontend`), and all **docs / plan / ROADMAP / config** work.
